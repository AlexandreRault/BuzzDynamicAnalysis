...
public class buzzParseTreeTraceInjectionPrettyPrintMain {
    ...
    public static void main(String args[]) {
		...
		buzzUnparsePrettyPrintVisCl buzzUnparsePrettyPrintVis = new buzzUnparsePrettyPrintVisCl();
		buzzUnparsePrettyPrintVis.initParams(astTable);
		buzzUnparsePrettyPrintVis.visit(rootNodeId, 0);
