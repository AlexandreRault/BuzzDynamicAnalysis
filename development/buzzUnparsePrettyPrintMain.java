...
public class buzzUnparsePrettyPrintMain {
    ...
    public static void main(String args[]) {
	    ...
	    buzzUnparsePrettyPrintVisCl buzzPrettyParseVis =
	        new buzzUnparsePrettyPrintVisCl();
	    buzzPrettyParseVis.initParams(astTable);
		buzzPrettyParseVis.visit(rootNodeId, 0);
